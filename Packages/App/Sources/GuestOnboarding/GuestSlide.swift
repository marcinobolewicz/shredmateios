...
extension GuestSlide {
    ...
    static let all: [GuestSlide] = [
        GuestSlide(
            id: "instructor",
            imageURL: URL(string: "https://images.unsplash.com/photo-1498146831523-fbe41acdc5ad?w=980&h=1920&fit=crop")!,
        ...
        GuestSlide(
            id: "buddy",
            imageURL: URL(string: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=980&h=1920&fit=crop")!,
        ...
        GuestSlide(
            id: "sessions",
            imageURL: URL(string: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=980&h=1920&fit=crop")!,
